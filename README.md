...
### 🎮 [Keksi-HUD](https://github.com/ImperatorKeksi/Keksi-HUD) — Custom Game HUD

> Modernes, minimalistisches HUD-Design für Spiele
...
### 🎨 [loading](https://github.com/ImperatorKeksi/loading) — Loading Screen & UI

> Moderne Loading-Animations und UI-Komponenten
...
Ich bin ein großer Fan von **Open Source**. Mein Code steht allen frei zur Verfügung — zum Lernen, Weiterentwickeln und Nutzen.
...
> **Einfach eine kleine Erwähnung reicht mir völlig.** Ich will nicht dass jemand sagt "das hab ich alles selbst programmiert" wenn der Kern von meinem Code kommt. Ein einfacher Hinweis wie "Teile dieses Codes basieren auf der Arbeit von ImperatorKeksi" oder "Mit Code von github.com/ImperatorKeksi" ist völlig ausreichend.
...
### ⭐ Wenn dir mein Profil gefällt, gib einem meiner Projekte einen Stern! ⭐

<img src="https://komarev.com/ghpvc/?username=ImperatorKeksi&color=orange&style=for-the-badge&label=BESUCHER"/>
